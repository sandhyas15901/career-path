...
import { ArrowLeft, Clock, TrendingUp, CheckCircle, BookOpen, Target, BarChart3, ChevronRight, GraduationCap, Building2, Shield, HelpCircle, Lightbulb } from 'lucide-react';
import { AppScreen } from '../context/AppContext';

interface EntrepreneurshipStartupManagementDiplomaScreenProps {
  setScreen: (screen: AppScreen) => void;
}

const EntrepreneurshipStartupManagementDiplomaScreen: React.FC<EntrepreneurshipStartupManagementDiplomaScreenProps> = ({ setScreen }) => {

  const courseData = {
    icon: '🟫',
    color: 'from-yellow-500 to-yellow-600',
    title: 'Entrepreneurship & Startup Management Diploma',
    subtitle: 'Develop startup planning, business development, leadership skills, and small business Management',
    duration: '1–2 Years',
    difficulty: 'Hard',
    industryDemand: 'Medium',
    salary: '₹2-20 LPA',
    eligibility: '10th pass with minimum 50% marks',
    description: 'Develop comprehensive entrepreneurship and startup management skills including business planning, startup management, leadership development, and small business operations for modern business environments.',
    coreFocus: 'Entrepreneurship, business planning, leadership Development',
    technicalLevel: 'Medium',
    creativeLevel: 'Very High',
    skills: ['Entrepreneurship', 'Business Planning', 'Leadership', 'Innovation', 'Risk Management', 'Business Development'],
    careerPaths: [
      {
        title: 'Startup Assistant',
        description: 'Support startup operations and assist entrepreneurs',
        salary: '₹3-12 LPA',
        growth: 'Startup Manager → Business Owner'
      },
      {
        title: 'Small Business Owner',
        description: 'Run and manage your own small business',
        salary: '₹4-20 LPA',
        growth: 'Business Expansion → Multiple Business Units'
      },
      {
        title: 'Business Development Executive',
        description: 'Develop business opportunities and partnerships',
        salary: '₹4-15 LPA',
        growth: 'Senior Executive → Business Development Head'
      }
    ],
    higherStudies: [
      {
        title: 'BBA Entrepreneurship Lateral Entry',
        description: 'Direct admission to 2nd year of BBA with entrepreneurship specialization',
        eligibility: 'Diploma with 60% marks'
      },
      {
        title: 'MBA Entrepreneurship',
        description: 'MBA with entrepreneurship and innovation focus',
        eligibility: 'Diploma + work experience + entrance exam'
      },
      {
        title: 'Startup Incubator Programs',
        description: 'Join startup incubators for funding and mentorship',
        eligibility: 'Diploma + business idea'
      }
    ],
    certifications: [
      {
        title: 'Entrepreneurship Certificate',
        issuer: 'Various Business Schools',
        duration: '6 months'
      },
      {
      ...
      {
        title: 'Business Plan Certification',
        issuer: 'Business Planning Institutes',
        duration: '4 months'
      }
    ],
    curriculum: [
      {
        semester: 'Year 1',
        subjects: ['Entrepreneurship Fundamentals', 'Business Planning', 'Market Research', 'Financial Management', 'Legal Requirements', 'Communication Skills']
      },
      {
        semester: 'Year 2',
        subjects: ['Startup Management', 'Innovation & Creativity', 'Digital Entrepreneurship', 'Funding & Investment', 'Risk Management', 'Business Model Development']
      }
    ],
    industryPartners: [
      {
        name: 'Startup Incubators',
        type: 'Mentorship & Funding'
      },
      {
        name: 'Business Accelerators',
        type: 'Growth Programs & Networking'
      },
      {
        name: 'Angel Investor Networks',
        type: 'Pitch Events & Investment'
      }
    ],
    governmentJobs: [
      {
        title: 'Startup Coordinator',
        department: 'MSME Development Centers',
        salary: '₹4-12 LPA',
        eligibility: 'Graduate + entrepreneurship knowledge'
      },
      {
        title: 'Business Development Officer',
        department: 'District Industries Centers',
        salary: '₹3-10 LPA',
        eligibility: '10th/12th pass + business development experience'
      },
      {
        title: 'Innovation Fund Executive',
        department: 'Technology Development Boards',
        salary: '₹5-15 LPA',
        eligibility: 'Graduate + innovation background'
      }
    ],
    faq: [
      {
        question: 'What is the scope of Entrepreneurship & Startup Management diploma?',
        answer: 'Excellent scope in startups, small businesses, business development, innovation centers, and entrepreneurship support roles.'
      },
      {
        question: 'Can I start my own business after this diploma?',
        answer: 'Yes, this diploma provides the foundation for starting and managing your own business, with practical skills in business planning and management.'
      },
      {
        question: 'What skills are most important for success?',
        answer: 'Leadership, innovation, business planning, risk assessment, and adaptability are crucial for entrepreneurial success.'
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-yellow-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-center mb-8">
          <div className="flex items-center justify-center text-white/70 text-sm flex-wrap">
            ...
            <span className="mx-2">→</span>
            <span className="text-white font-medium">Entrepreneurship & Startup Management Diploma</span>
          </div>
        </motion.div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Excellent opportunities in entrepreneurship, startups, and business innovation</p>
              </div>
            </div>
          </div>
        </motion.div>
              ...
              {courseData.careerPaths.map((path, index) => (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-yellow-400 text-sm font-medium">{path.growth}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {courseData.higherStudies.map((study, index) => (
                ...
                >
                  ...
                  <p className="text-white/70 text-xs bg-yellow-500/20 rounded px-3 py-2 inline-block">
                    {study.eligibility}
                  </p>
                </motion.div>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {courseData.industryPartners.map((partner, index) => (
                ...
                >
                  ...
                  <p className="text-white/80 text-sm mt-2">Mentorship, funding, and networking opportunities for aspiring entrepreneurs</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }} className="text-center">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Ready to Start Your Entrepreneurship Journey?</h2>
            <p className="text-white/80 text-lg mb-8">Gain the skills and knowledge needed to excel in entrepreneurship, startup management, and business innovation.</p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <button className="px-8 py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-medium rounded-xl transition-colors">
...
export default EntrepreneurshipStartupManagementDiplomaScreen;
