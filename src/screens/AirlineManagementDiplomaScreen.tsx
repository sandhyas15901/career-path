...
import { ArrowLeft, Plane, Users, Luggage, MapPin, CheckCircle, TrendingUp, Award, Globe } from 'lucide-react';
import { useApp } from '../context/AppContext';

export default function AirlineManagementDiplomaScreen() {
  ...
  const specializations = [
    {
      ...
      icon: Users,
      title: 'Cabin Crew',
      description: 'Master in-flight service, passenger safety, and customer care excellence',
      skills: ['In-flight Service', 'Passenger Safety', 'Customer Care', 'Emergency Procedures'],
      careers: ['Cabin Crew Member', 'Flight Attendant', 'In-flight Manager', 'Cabin Crew Instructor'],
      duration: '6 months',
    ...
    },
    {
      ...
      description: 'Learn airport operations, check-in procedures, and ground handling services',
      skills: ['Airport Operations', 'Check-in Procedures', 'Ground Handling', 'Baggage Management'],
      careers: ['Ground Staff', 'Airport Operations Manager', 'Check-in Supervisor', 'Baggage Handler'],
      duration: '6 months',
    ...
    },
    {
      ...
      description: 'Study airline operations, fleet management, and aviation business administration',
      skills: ['Airline Operations', 'Fleet Management', 'Aviation Business', 'Route Planning'],
      careers: ['Airline Manager', 'Operations Manager', 'Fleet Coordinator', 'Route Planner'],
      duration: '6 months',
    ...
    },
    {
      ...
      description: 'Master air cargo handling, logistics management, and freight operations',
      skills: ['Cargo Handling', 'Logistics Management', 'Freight Operations', 'Customs Procedures'],
      careers: ['Cargo Manager', 'Logistics Coordinator', 'Freight Operations Manager', 'Customs Agent'],
      duration: '6 months',
  ...
  const programHighlights = [
    {
      ...
      description: 'Hands-on experience with airlines and aviation companies'
    },
    {
      icon: TrendingUp,
      title: 'Global Opportunities',
      description: 'Career opportunities with international airlines'
    },
    {
      icon: Award,
      title: 'Certifications',
      description: 'IATA and aviation industry certifications'
    },
    {
      icon: Globe,
      title: 'Travel Benefits',
      description: 'Exciting travel perks and industry benefits'
    }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Background Blobs */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-sky-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-center mb-8 text-white/70 text-sm">
          ...
          <span className="mx-2">→</span>
          <span className="text-white font-medium">Airline Management Diploma</span>
        </div>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center text-white">
              <Plane className="w-8 h-8" />
            </div>
            <h1 className="text-4xl font-bold text-white">Airline Management Diploma</h1>
          </div>
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            Comprehensive airline education covering cabin crew, ground operations, airline management, and cargo operations
          </p>
        </motion.div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">Cabin Crew - ₹3-8 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Ground Staff - ₹2-6 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Airline Manager - ₹5-15 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Cargo Manager - ₹4-12 LPA</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {programHighlights.map((highlight, index) => {
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center text-white mx-auto mb-4">
                    <Icon className="w-7 h-7" />
                  </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">Aviation safety and security procedures</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Airport operations and ground handling</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Cargo and freight operations</span>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Emergency response and crisis management</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Teamwork and leadership</span>
                </div>
              </div>
            </div>
          </div>
