...
import { ArrowLeft, Clock, TrendingUp, CreditCard, CheckCircle, BookOpen, Target, BarChart3, ChevronRight, GraduationCap, Building2, Shield, HelpCircle } from 'lucide-react';
import { AppScreen } from '../context/AppContext';

interface BankingInsuranceDiplomaScreenProps {
  setScreen: (screen: AppScreen) => void;
}

const BankingInsuranceDiplomaScreen: React.FC<BankingInsuranceDiplomaScreenProps> = ({ setScreen }) => {

  const courseData = {
    icon: '🟨',
    color: 'from-purple-500 to-purple-600',
    title: 'Banking & Insurance Diploma',
    subtitle: 'Master banking operations, financial services, insurance Systems, and Customer Handling',
    duration: '2–3 Years',
    difficulty: 'Medium',
    industryDemand: 'High',
    salary: '₹3-14 LPA',
    eligibility: '10th pass with minimum 50% marks',
    description: 'Develop comprehensive banking and insurance skills including financial services, customer relationship management, risk assessment, and insurance product knowledge.',
    coreFocus: 'Banking operations, insurance products, financial Services',
    technicalLevel: 'Medium',
    creativeLevel: 'Medium',
    skills: ['Banking Operations', 'Customer Service', 'Financial Products', 'Risk Assessment', 'Insurance Knowledge', 'Communication'],
    careerPaths: [
      {
        title: 'Banking Assistant',
        description: 'Support banking operations and handle customer transactions',
        salary: '₹3-10 LPA',
        growth: 'Relationship Manager → Branch Manager'
      },
      {
        title: 'Insurance Advisor Assistant',
        description: 'Assist clients with insurance products and claims',
        salary: '₹3-11 LPA',
        growth: 'Insurance Advisor → Senior Advisor'
      },
      {
        title: 'Relationship Executive',
        description: 'Manage client relationships and financial services',
        salary: '₹4-14 LPA',
        growth: 'Senior Executive → Branch Manager'
      }
    ],
    higherStudies: [
      {
        title: 'BBA Banking Lateral Entry',
        description: 'Direct admission to 2nd year of BBA with banking specialization',
        eligibility: 'Diploma with 60% marks'
      },
      {
        title: 'B.Com Finance Specialization',
        description: 'Direct admission to 2nd year of B.Com with finance focus',
        eligibility: 'Diploma + entrance exam'
      },
      {
        title: 'Insurance Certification Programs',
        description: 'Professional insurance certification courses',
        eligibility: 'Diploma + work experience'
      }
    ],
    certifications: [
      {
        title: 'Banking Operations Certificate',
        issuer: 'Banking Training Institutes',
        duration: '6 months'
      },
      {
        title: 'Insurance Advisor License',
        issuer: 'Insurance Regulatory Authority',
        duration: '3 months preparation'
      },
      {
        title: 'Financial Services Certification',
        issuer: 'Financial Services Board',
        duration: '4 months'
      }
    ],
    curriculum: [
      {
        semester: 'Year 1',
        subjects: ['Banking Principles', 'Financial Services', 'Customer Relationship Management', 'Business Mathematics', 'Communication Skills', 'Computer Applications']
      },
      {
        semester: 'Year 2',
        subjects: ['Retail Banking', 'Corporate Banking', 'Insurance Fundamentals', 'Risk Management', 'Loan Processing', 'Digital Banking']
      },
      {
        semester: 'Year 3',
        subjects: ['Investment Banking', 'International Banking', 'Treasury Operations', 'Compliance & Regulations', 'Financial Analysis', 'Project Work']
      }
    ],
    industryPartners: [
      {
    ...
    governmentJobs: [
      {
        ...
        salary: '₹3-8 LPA',
        eligibility: '10th/12th pass + banking knowledge'
      },
      {
        title: 'Insurance Officer',
        department: 'Insurance Corporations',
        salary: '₹4-10 LPA',
        eligibility: 'Graduate + insurance knowledge'
      },
      {
        title: 'Financial Service Executive',
        department: 'Financial Institutions',
        salary: '₹4-12 LPA',
        eligibility: 'Commerce graduate + finance background'
      }
    ],
    faq: [
      {
        question: 'What is the scope of Banking & Insurance diploma?',
        answer: 'Excellent scope in banks, insurance companies, financial services Firms, and Government Financial Institutions.'
      },
      {
        question: 'Can I pursue specialized banking courses after this diploma?',
        answer: 'Yes, you can specialize in Investment Banking, Retail Banking, or Insurance Underwriting with advanced certifications.'
      },
      {
        question: 'What skills are most important for success?',
        answer: 'Customer service, financial product knowledge, risk assessment, communication, and adaptability to technology are crucial.'
      }
    ]
  };
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-center mb-8">
          <div className="flex items-center justify-center text-white/70 text-sm flex-wrap">
            ...
            <span className="mx-2">→</span>
            <span className="text-white font-medium">Banking & Insurance Diploma</span>
          </div>
        </motion.div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Excellent opportunities in banking and insurance sectors</p>
              </div>
            </div>
          </div>
        </motion.div>
              ...
              {courseData.careerPaths.map((path, index) => (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-purple-400 text-sm font-medium">{path.growth}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {courseData.higherStudies.map((study, index) => (
                ...
                >
                  ...
                  <p className="text-white/70 text-xs bg-purple-500/20 rounded px-3 py-2 inline-block">
                    {study.eligibility}
                  </p>
                </motion.div>
              ))}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }} className="text-center">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Ready to Start Your Banking & Insurance Journey?</h2>
            <p className="text-white/80 text-lg mb-8">Gain the skills and knowledge needed to excel in banking and insurance roles across financial institutions.</p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <button className="px-8 py-3 bg-purple-500 hover:bg-purple-600 text-white font-medium rounded-xl transition-colors">
...
export default BankingInsuranceDiplomaScreen;
