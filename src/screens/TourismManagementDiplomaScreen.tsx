...
import { ArrowLeft, Plane, MapPin, Users, CheckCircle, TrendingUp, Award, Globe } from 'lucide-react';
import { useApp } from '../context/AppContext';

export default function TourismManagementDiplomaScreen() {
  const { setScreen } = useApp();

  const specializations = [
    {
      id: 'travel-agency-operations',
      icon: MapPin,
      title: 'Travel Agency Operations',
      description: 'Master travel booking, itinerary planning, and customer service for travel agencies',
      skills: ['Travel Booking', 'Itinerary Planning', 'Customer Service', 'Destination Knowledge'],
      careers: ['Travel Agent', 'Tour Operator', 'Travel Consultant', 'Destination Specialist'],
      duration: '6 months',
    ...
    },
    {
      ...
      icon: Users,
      title: 'Tour Guiding',
      description: 'Learn tour leadership, cultural presentation, and group management techniques',
      skills: ['Tour Leadership', 'Cultural Presentation', 'Group Management', 'Storytelling'],
      careers: ['Tour Guide', 'Heritage Guide', 'Adventure Guide', 'Cultural Interpreter'],
      duration: '6 months',
    ...
    },
    {
      ...
      description: 'Study destination marketing, tourism development, and regional tourism planning',
      skills: ['Destination Marketing', 'Tourism Development', 'Regional Planning', 'Stakeholder Management'],
      careers: ['Destination Manager', 'Tourism Development Officer', 'Marketing Manager', 'Regional Coordinator'],
      duration: '6 months',
    ...
    },
    {
      ...
      description: 'Master adventure sports management, outdoor activities, and eco-tourism operations',
      skills: ['Adventure Sports', 'Safety Management', 'Eco-Tourism', 'Risk Assessment'],
      careers: ['Adventure Tourism Manager', 'Eco-Tourism Specialist', 'Adventure Guide', 'Outdoor Activity Coordinator'],
      duration: '6 months',
  ...
  const programHighlights = [
    {
      ...
      description: 'Internships with travel agencies and tourism companies'
    },
    {
      icon: TrendingUp,
      title: 'Global Opportunities',
      description: 'Career opportunities in international tourism'
    },
    {
      icon: Award,
      title: 'Certifications',
      description: 'IATA and other industry-recognized certifications'
    },
    {
      icon: Globe,
      title: 'Cultural Learning',
      description: 'Exposure to diverse cultures and destinations'
    }
  ];
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-center mb-8 text-white/70 text-sm">
          ...
          <span className="mx-2">→</span>
          <span className="text-white font-medium">Tourism Management Diploma</span>
        </div>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-white">Tourism Management Diploma</h1>
          </div>
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            Comprehensive tourism education covering travel operations, tour guiding, destination management, and adventure tourism
          </p>
        </motion.div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">Tourism Manager - ₹4-12 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Travel Agent - ₹3-8 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Tour Operator - ₹4-10 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Destination Manager - ₹5-15 LPA</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {programHighlights.map((highlight, index) => {
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white mx-auto mb-4">
                    <Icon className="w-7 h-7" />
                  </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">Travel booking and reservation systems</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Tour planning and itinerary design</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Destination knowledge and geography</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Tourism marketing and promotion</span>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Communication and presentation skills</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Cultural sensitivity and awareness</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Problem-solving and crisis management</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Leadership and group management</span>
                </div>
              </div>
            </div>
          </div>
