...
import { ArrowLeft, TreePine, Flower, Apple, Leaf, Sun, Droplets, CheckCircle } from 'lucide-react';
import { useApp } from '../context/AppContext';

export default function HorticultureDiplomaScreen() {
  const { setScreen } = useApp();

  const specializations = [
    {
      id: 'fruit-cultivation',
      icon: Apple,
      title: 'Fruit Cultivation',
      description: 'Study fruit tree management, orchard practices, and fruit production',
      skills: ['Fruit Tree Pruning', 'Orchard Management', 'Harvesting Techniques', 'Post-Harvest Handling'],
      careers: ['Fruit Farm Manager', 'Orchard Supervisor', 'Horticulture Technician'],
      duration: '6 months',
    ...
    },
    {
      ...
      description: 'Learn vegetable farming, greenhouse management, and organic vegetable production',
      skills: ['Vegetable Farming', 'Greenhouse Management', 'Organic Farming', 'Pest Control'],
      careers: ['Vegetable Farm Manager', 'Greenhouse Supervisor', 'Organic Farming Consultant'],
      duration: '6 months',
    ...
    },
    {
      ...
      icon: Flower,
      title: 'Floriculture',
      description: 'Master flower cultivation, floral design, and ornamental plant production',
      skills: ['Flower Cultivation', 'Floral Design', 'Greenhouse Management', 'Ornamental Plants'],
      careers: ['Floriculture Manager', 'Floral Designer', 'Nursery Manager'],
      duration: '6 months',
    ...
    },
    {
      ...
      description: 'Study landscape design, garden maintenance, and urban horticulture',
      skills: ['Landscape Design', 'Garden Maintenance', 'Urban Horticulture', 'Plant Selection'],
      careers: ['Landscape Designer', 'Garden Manager', 'Urban Horticulturist'],
      duration: '6 months',
  ...
  const programHighlights = [
    {
      ...
      description: 'Practical experience in modern horticulture farms and greenhouses'
    },
    {
      icon: Sun,
      title: 'Modern Techniques',
      description: 'Learn latest horticulture technologies and sustainable practices'
    },
    {
      icon: Droplets,
      title: 'Irrigation Management',
      description: 'Master modern irrigation systems and water management techniques'
    },
    {
      icon: Leaf,
      title: 'Organic Farming',
      description: 'Specialized training in organic horticulture and sustainable agriculture'
    }
  ];
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-center mb-8 text-white/70 text-sm">
          ...
          <span className="mx-2">→</span>
          <span className="text-white font-medium">Horticulture Diploma</span>
        </div>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-white">Horticulture Diploma</h1>
          </div>
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            Comprehensive horticulture education covering fruit cultivation, vegetable farming, floriculture, and landscape management
          </p>
        </motion.div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">Horticulturist - ₹3-8 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Garden Manager - ₹4-10 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Landscape Designer - ₹5-12 LPA</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Plant Nursery Manager - ₹3-7 LPA</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">Plant propagation and nursery management</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Soil management and fertility control</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Pest and disease management</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-blue-400" />
                  <span className="text-white/80">Irrigation and water management</span>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Horticulture business management</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Marketing and distribution</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Quality control and post-harvest management</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
                  <span className="text-white/80">Sustainable horticulture practices</span>
                </div>
              </div>
            </div>
          </div>
